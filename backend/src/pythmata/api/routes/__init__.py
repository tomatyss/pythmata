...
from pythmata.api.routes.process_version_migration import router as process_version_migration_router
...
router.include_router(process_version_migration_router)