...
class CompensationScope:
    ...
    def __init__(
        self, scope_id: str, parent_scope: Optional["CompensationScope"] = None
    ):
        """
    ...
    def get_handler_for_activity(
        self, activity_id: str
    ) -> Optional["CompensationBoundaryEvent"]:
...
class CompensationEventDefinition:
    ...
    def __init__(
        ...
        scope: Optional[CompensationScope] = None,
    ):
        """
...
class CompensationActivity(Event):
    ...
    def __init__(
        self,
        event_id: str,
        compensate_activity_id: Optional[str] = None,
        scope: Optional[CompensationScope] = None,
    ):
        """
