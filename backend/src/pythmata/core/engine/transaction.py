...
class Transaction(CompensationScope):
    ...
    def __init__(self, transaction_id: str, instance_id: str, parent_scope: Optional['CompensationScope'] = None):
        """
...
class TransactionContext:
    ...
    def __init__(self, transaction: Transaction):
        ...
        self._participants: Dict[str, Token] = {}  # Maps activity IDs to their completion tokens
    ...
    async def rollback(self) -> Token:
        ...
        if not handler:
            raise ValueError(f"No compensation handler found for activity {activity_id}")
