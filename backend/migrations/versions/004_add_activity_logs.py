...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('instance_id', postgresql.UUID(
    ...
    # Create indexes
    op.create_index('idx_activity_logs_instance_id',
                    'activity_logs', ['instance_id'])
    op.create_index('idx_activity_logs_timestamp',
