...
from pythmata.core.websockets.chat_manager import ChatConnectionManager, ChatWebSocketMessage
...
async def test_send_personal_message_exception(chat_manager, mock_websocket):
    ...
    # Send a personal message
    with patch('pythmata.core.websockets.chat_manager.logger.error') as mock_error, \
...
async def test_broadcast_to_session_exclude_client(chat_manager, mock_websocket):
    ...
    await chat_manager.broadcast_to_session(session_id, "test_type", {}, exclude_client=client_id1)
