...
class TestProcessExecutor(BaseEngineTest):
    ...
    async def test_variable_passing_between_nodes(self):
        ...
        current_value = (await self.state_manager.get_variable(instance_id, "value")).value
        ...
        final_value = (await self.state_manager.get_variable(instance_id, "value")).value
        path_taken = (await self.state_manager.get_variable(instance_id, "path_taken")).value
        ...
        expected_summary = "Final value: 10, Path taken: low, Original message: Initial message"
    ...
    async def test_variable_passing_alternate_path(self):
        ...
        # Verify the summary variable was created
        expected_summary = "Final value: 25, Path taken: high, Original message: Initial message"
        assert variables["summary"].value == expected_summary
