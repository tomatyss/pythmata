...
class TestInclusiveGateway:
    ...
    async def test_multiple_path_activation(self):
        ...
        token = Token(
            instance_id="test-1",
            node_id="Gateway_1",
            data={"amount": 1500, "urgent": True, "category": "special"},
        )
    ...
    async def test_no_matching_conditions(self):
        ...
        token = Token(
            instance_id="test-2",
            node_id="Gateway_1",
            data={"amount": 500, "urgent": False, "category": "normal"},
        )
    ...
    async def test_subset_conditions_matching(self):
        ...
        token = Token(
            instance_id="test-3",
            node_id="Gateway_1",
            data={"amount": 1500, "urgent": False, "category": "normal"},
        )
    ...
    async def test_complex_conditions(self):
        ...
        flows = {
            ...
            "Flow_3": {"condition": "${amount < 1000 || status != 'approved'}"},
        }
