...
class MockStateManager:
    ...
    async def set_signal_subscription(self, *args, **kwargs): pass
    async def wait_for_signal(self, *args, **kwargs): pass
    async def remove_signal_subscription(self, *args, **kwargs): pass
