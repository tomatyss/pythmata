...
async def test_error_boundary_event_basic():
    ...
    error_event = ErrorBoundaryEvent(
        event_id="Error_1", attached_to_id="Task_1", error_code="Error_Code_1"
    )
    ...
    token = Token(
        ...
        data={"error": {"code": "Error_Code_1", "message": "Test error"}},
    )
...
async def test_multiple_error_boundary_events():
    ...
    error_event_2 = ErrorBoundaryEvent(
        event_id="Error_2", attached_to_id="Task_1", error_code="Error_Code_2"
    )
    ...
    token_1 = Token(
        ...
        node_id="Task_1",
        state=TokenState.ERROR,
        data={"error": {"code": "Error_Code_1", "message": "Test error 1"}},
    )
    ...
    token_2 = Token(
        ...
        node_id="Task_1",
        state=TokenState.ERROR,
        data={"error": {"code": "Error_Code_2", "message": "Test error 2"}},
    )
...
async def test_error_propagation():
    ...
    task_error_event = ErrorBoundaryEvent(
        event_id="Task_Error", attached_to_id="Task_1", error_code="Error_Code_1"
    )
