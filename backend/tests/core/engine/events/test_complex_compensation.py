...
async def test_nested_compensation_propagation():
    ...
    subprocess_scope = CompensationScope(scope_id="Subprocess_1", parent_scope=process_scope)
...
async def test_nested_compensation_isolation():
    ...
    # Create scopes
    process_scope = CompensationScope(scope_id="Process_1")
    subprocess1_scope = CompensationScope(scope_id="Subprocess_1", parent_scope=process_scope)
    subprocess2_scope = CompensationScope(scope_id="Subprocess_2", parent_scope=process_scope)
