...
class TestCyclicGraphs(BaseEngineTest):
    ...
    def create_cyclic_flow(self) -> dict:
        ...
        return {
            ...
            "flows": [
                ...
                {"id": "Flow_2", "source_ref": "Task_3", "target_ref": "Task_2"}  # Cycle back to Task_2
            ]
        }
    ...
    async def test_iteration_limit(self):
        ...
        graph = {
            ...
            "flows": [
                {"id": "Flow_1", "source_ref": "Start_1", "target_ref": "Task_1"},
                {"id": "Flow_2", "source_ref": "Task_1", "target_ref": "Task_1"},  # Self-loop
                {"id": "Flow_3", "source_ref": "Task_1", "target_ref": "End_1"}  # Path to end
            ]
        }
